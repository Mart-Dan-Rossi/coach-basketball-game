...
const CreateTeam = ({
  ...
  return (
    ...
    >
      ...
      <PlayersSelectors
        team={team}
        pointsUsedOnPlayersArray={
          team === "A" ? pointsUsedOnPlayersAArray : pointsUsedOnPlayersBArray
        }
      />
      ...
      <div className="all-player-customization-container">
        <SwitchTransition>
          ...
          >
            {createPlayer == 0 ? (
              <p>
                Remember, you have {maxTeamPoints} points to spend among your 5
                players. You can balance the score between them or enhance any
                of them.
              </p>
            ) : (
              <CreatePlayer
