...
export interface GameContextProps {
  ...
  setPointsUsedInStatsPlayerA1: React.Dispatch<
    React.SetStateAction<PlayerStats>
  >;
  setPointsUsedInStatsPlayerA2: React.Dispatch<
    React.SetStateAction<PlayerStats>
  >;
  setPointsUsedInStatsPlayerA3: React.Dispatch<
    React.SetStateAction<PlayerStats>
  >;
  setPointsUsedInStatsPlayerA4: React.Dispatch<
    React.SetStateAction<PlayerStats>
  >;
  setPointsUsedInStatsPlayerA5: React.Dispatch<
    React.SetStateAction<PlayerStats>
  >;
  ...
  setPointsUsedInStatsPlayerB1: React.Dispatch<
    React.SetStateAction<PlayerStats>
  >;
  setPointsUsedInStatsPlayerB2: React.Dispatch<
    React.SetStateAction<PlayerStats>
  >;
  setPointsUsedInStatsPlayerB3: React.Dispatch<
    React.SetStateAction<PlayerStats>
  >;
  setPointsUsedInStatsPlayerB4: React.Dispatch<
    React.SetStateAction<PlayerStats>
  >;
  setPointsUsedInStatsPlayerB5: React.Dispatch<
    React.SetStateAction<PlayerStats>
  >;
  ...
  setShowInterceptPassAttemptButton: React.Dispatch<
  ...
  setShowWaitWithoutTheBallButton: React.Dispatch<
    React.SetStateAction<boolean>
  >;
  ...
  addClassIfNeeded: (teamNumber: number, col: number, row: number) => void;

  matchState: Match;

  clickTileHandler: (teamNumber: number, col: number, row: number) => void;
}
